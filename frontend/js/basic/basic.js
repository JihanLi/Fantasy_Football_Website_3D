 ...
 * basic.js
 * 
 * This JavaScript file decides some css properties for team.html and position.html. 
 * 
...
$(document).ready(function(){resizeDiv();onWindowResize();});
...
function resizeDiv() 
{
    ...
    var rightWidth = $("#right-half").width();
    var rightHeight = $("#right-half").height();
    var dataWidth = $("#data-zone").width();
    var tableHeight = (rightHeight-150)*0.7;
    
    var infoOffset = $("#container").width()-$("#infoPanel").width()-30;
    if(windowWidth > 1140)
    {
    ...
    $("#chart-zone").css("left", dataWidth +"px"); 
    $("#chart-zone").css("width", (windowWidth-rightWidth-dataWidth) +"px"); 
    $("#infoPanel").css("left", infoOffset +"px"); 
};
